  ...
  <div class="app-container">
    <el-form ref="queryForm" :inline="true">
      <el-form-item label="工作名称">
        <el-input placeholder="请输入工作名称" v-model="search.title" clearable size="small" />
      </el-form-item>
      <el-form-item label="工作分类">
        <el-select v-model="search.categoryId" placeholder="请选择工作分类">
          <el-option
      ...
      <el-form-item label="工作级别" prop="level">
        <el-select v-model="search.level" placeholder="请选择工作级别">
